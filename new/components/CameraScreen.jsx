...
export default function CameraScreen({ onCapture, onBack }) {
  ...
  return (
    <div className="flex flex-col min-h-dvh px-6 py-10 bg-pantry animate-fade-in-up pt-safe">
      {/* back button */}
      <button
        onClick={onBack}
      ...
      <div className="w-full max-w-xs mx-auto flex flex-col gap-3 mt-auto pb-safe">
        <button
